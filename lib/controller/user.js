...
UserController.prototype.authenticate = function (email, password) {
  var deferred = Q.defer();
...
UserController.prototype.getUser = function (email, password, cb) {
  UserModel.authenticate(email, password).then(function (user) {
